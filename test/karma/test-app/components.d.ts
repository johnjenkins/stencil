...
export namespace Components {
    ...
    interface MixedInBasic {
        "methodFromComponent": () => Promise<string>;
        "nameClash": string;
        "nameFiltered": string;
        "propFromComponent": string;
    }
    interface MixinBasic {
        "methodFromBasicClass": () => Promise<string>;
        "methodFromComponent": () => Promise<string>;
        "nameClash": boolean;
...
declare global {
    ...
    interface HTMLMixedInBasicElement extends Components.MixedInBasic, HTMLStencilElement {
    }
    var HTMLMixedInBasicElement: {
        prototype: HTMLMixedInBasicElement;
        new (): HTMLMixedInBasicElement;
    };
    interface HTMLMixinBasicElement extends Components.MixinBasic, HTMLStencilElement {
    }
    var HTMLMixinBasicElement: {
...
declare namespace LocalJSX {
    ...
    interface MixedInBasic {
        "nameClash"?: string;
        "nameFiltered"?: string;
        "onEventFromComponent"?: (event: CustomEvent<string>) => void;
        "propFromComponent"?: string;
    }
    interface MixinBasic {
        "nameClash"?: boolean;
        "onEventFromBasicClass"?: (event: CustomEvent<string>) => void;
        "onEventFromComponent"?: (event: CustomEvent<string>) => void;
        "propFromBasicClass"?: string;
        "propFromComponent"?: string;
    }
